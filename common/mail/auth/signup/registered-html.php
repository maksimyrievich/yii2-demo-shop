...
<div style="background: #eff3f6; height: 100%">
    <table width="95%" align="center" border="0" cellspacing="0" cellpadding="10" style="max-width:600px; margin-bottom: 90px;">
        <tbody>
            <tr>
                <td style="text-align: left; width: 50%" bgcolor="#eff3f6">
                    <a href="https://avtosezam.ru" target="_blank" rel="noopener noreferrer"><img src="https://static.avtosezam.ru/image/logo.png"></a>
                </td>
            ...
            <tr style="background: #ffffff; border-spacing: 0; border-collapse: collapse; width: 95%" cellspacing="0" cellpadding="0" border="0">
                <td style="padding: 15px; border-collapse: collapse" colspan="2" align="left">
                    ...
                    <p style="margin: 0; padding: 0; margin-bottom: 0;font-family: Helvetica,Arial,sans-serif; color: #333; font-size: 14px">Вы зарегистрированы на сайте <a href="https://www.avtosezam.ru" target="_blank" rel="noopener noreferrer">www.avtosezam.ru</a>.</p>
                    <p style="margin: 0; padding: 0; margin-bottom: 0;font-family: Helvetica,Arial,sans-serif; color: #333; font-size: 14px">Для входа на сайт используйте свои учётные данные:</p>
                    <p style="margin: 0; padding: 0; margin-bottom: 0;font-family: Helvetica,Arial,sans-serif; color: #333; font-size: 14px">&nbsp;</p>
                    <p style="margin: 0; padding: 0; margin-bottom: 0;font-family: Helvetica,Arial,sans-serif; font-weight: bold; color: #333; font-size: 14px">Логин: <?= Html::encode($user->username) ?></p>
                    <p style="margin: 0; padding: 0; margin-bottom: 0;font-family: Helvetica,Arial,sans-serif; font-weight: bold; color: #333; font-size: 14px">Пароль: <?= Html::encode($user->password) ?></p>
                    <p style="margin: 0; padding: 0; margin-bottom: 0;font-family: Helvetica,Arial,sans-serif; color: #333; font-size: 14px">&nbsp;</p>
                    <p style="margin: 0; padding: 0; margin-bottom: 0;font-family: Helvetica,Arial,sans-serif; color: #333; font-size: 14px">&nbsp;</p>
                    <p style="margin: 0; padding: 0; margin-bottom: 0;font-family: Helvetica,Arial,sans-serif; color: #333; font-size: 14px">Не удаляйте это письмо! Создайте папку "Регистрация на сайтах" и сохраните это письмо в ней.</p>
                </td>
            </tr>
        </tbody>
    </table>
