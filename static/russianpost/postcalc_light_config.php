...
$arrPostcalcConfig=array(
     // === ИСТОЧНИК ДАННЫХ ===
    'source' => 'mysql',                // Источник - либо txt, либо mysql. Для mysql требуется поддержка MySQLi
    ...
    'mysql_user' => 'd927138x_shop',    // Для mysql: имя пользователя БД
    'mysql_pass' => 'zTYo74GQ',         // Для mysql: пароль пользователя БД
    'mysql_db'   => 'd927138x_shop',    // Для mysql: имя базы данных
    
    // === НАСТРОЙКИ ЗАПРОСА ===
    'st' => 'd927138x.beget.tech',      // Название сайта, без http: и слэшей
    'ml' => 'kitaigorodskiy@mail.ru',   // Контактный email. Самый принципиальный параметр
    ...
    // === НАСТРОЙКИ ВЕБ-ФОРМЫ ===
    'default_from' => '413860',   // Отделение отправителя по умолчанию. 101000 - Московский главпочтамт.
    ...
    'servers' => array('test.postcalc.ru'), //'api.postcalc.ru', - на боевом сервере
